...
<img width="1662" height="718" alt="image" src="https://github.com/user-attachments/assets/7fb55495-1e58-4323-8ad4-75eb3b670218" />
...
<img width="1009" height="527" alt="image" src="https://github.com/user-attachments/assets/af20f55a-3e92-45e7-98eb-1a6ae1d59f6a" />

The above picture, clearly indicates that Docker Deamon is brain of Docker. If Docker Deamon is killed, docker stops working for some reasons.
...
<img width="1402" height="372" alt="image" src="https://github.com/user-attachments/assets/44d802dd-26a4-4cfb-9631-e767a5d19440" />
...
### Volumes 
A Docker volume is Docker‑managed storage that exists outside the container filesystem but is not tied to a specific host path that you directly work with. Creates a logical data storage inside host.
...
With a Docker bind mount, the host directory and the container directory point to the same underlying filesystem. The container can read all data from the host, and any changes made inside the container are immediately reflected on the host, and vice‑versa.
